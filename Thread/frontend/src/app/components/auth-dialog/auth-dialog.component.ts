...
export class AuthDialogComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit() {
        this.avatar = 'https://homepages.cae.wisc.edu/~ece533/images/airplane.png';
    ...
    public signUp() {
        this.authService
            .register({ userName: this.userName, password: this.password, email: this.email, avatar: this.avatar, emailConfirmed: this.emailConfirmed })
            .pipe(takeUntil(this.unsubscribe$))
            .subscribe((response) => this.dialogRef.close(response), (error) => this.snackBarService.showErrorMessage(error));
    }
}
